package cn.neteast.seckill.controller;

import cn.neteast.pojo.TbSeckillOrder;
import cn.neteast.seckill.service.SeckillGoodsService;
...
public class PayController {
    ...
    public Map createNative() {
        ...
        if (seckillOrder != null) {
            ...
            return weChatPayService.createNative(String.valueOf(seckillOrder.getId()), String.valueOf(fen / 1000));
    ...
    public Result queryPayStatus(String out_trade_no) {
        ...
        while (true) {
            ...
            //不让循环无休止地运行定义变量, 如果超过了这个值则退出循环, 设置时间为5分钟
            x++;
            if (x > 100) {
