...
import cn.neteast.mapper.TbSellerMapper;
import cn.neteast.pojo.TbSeller;
import cn.neteast.pojo.TbSellerExample;
import cn.neteast.pojo.TbSellerExample.Criteria;
...
public class SellerServiceImpl implements SellerService {
     ...
     */
    @Override
    public void changeSellerStatus(String sellerId, String statusId) {
        //先根据sellerId查询出Seller对象
        TbSeller tbSeller = sellerMapper.selectByPrimaryKey(sellerId);
        //再根据条件更新此Seller对象
        tbSeller.setStatus(statusId);
