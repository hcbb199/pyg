                        ...
                        <div class="clearfix choose">
                            <div id="specification" class="summary-wrap clearfix">
                                ...
                                <dl>
                                    ...
                                    <#list specification.attributeValue as attr>
                                    <dd>
                                        <a href="javascript:;" class="{{isSelected('${specification.attributeName}','${attr}')?'selected':''}}"
                                        ng-click="selectSpecification('${specification.attributeName}','${attr}')">${attr}<span title="点击取消选择">&nbsp;</span>
                                        </a>
                                    </dd>
                                    </#list>
                            ...
                            <div class="summary-wrap">
                                ...
                                <div class="fl">
                                    <ul class="btn-choose unstyled">
                                        <li>
                                            <a href="cart.html" class="sui-btn  btn-danger addshopcar"
